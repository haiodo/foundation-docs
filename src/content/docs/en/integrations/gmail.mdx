---
title: Gmail
description: Learn how to integrate Foundation with Gmail.
---

Foundation provides an optional integration with Gmail, allowing you to connect to a Gmail account to send and receive emails without ever leaving the platform. The current version of Gmail integration offers the following features:

* Send emails to contacts from Foundation
* Receive and reply to emails from contacts in Foundation
...
To connect with Gmail, navigate to Settings > Integrations. Under `Gmail`, click `Add` and select the Gmail account you want to connect. Follow the prompts to authorize Foundation to access your Gmail account.
