...
Contacts can be added using the `+` button in the top right corner of the Contacts page. For more on adding employees to your workspace, see this guide on managing [employees](/ru/people-contacts/employees).
