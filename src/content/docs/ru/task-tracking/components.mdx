...
Components are essentially a way to categorize issues within a project - similar to [labels](/ru/task-tracking/labels), but with a key difference: an issue can only belong to one component, whereas many labels can be added to a single issue.
...
[Milestones](/ru/task-tracking/milestones) are more useful when planning parts of a project related to timing or phases of work. Milestones move through the states Planned > In Progress > Completed, while components are simply used for categorizing issues around a topic or area.
...
Components can be used in the same way as milestones and labels for filtering and sorting issues in the Tracker. For more detailed steps, see [Viewing issues](/ru/task-tracking/viewing-issues).