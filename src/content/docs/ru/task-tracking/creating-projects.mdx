...
> **Note:** Only workspace owners and maintainers can create projects. To learn how to grant a user special permissions, see our guide on [roles](/ru/advanced-settings/roles).
