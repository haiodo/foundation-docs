...
description: Learn how Hulia — Foundation's AI assistant — can transcribe your meetings in real time.
---
...
Meet Hulia, Foundation's first AI assistant! Hulia transcribes meetings in real-time, saved as a chat correspondence in which you can react, reply, and bookmark messages as you would in any other chat.
...
Live transcriptions are just the beginning for Hulia. At this point, live transcription may not be useful for everyone on Foundation; however, soon Hulia will be able to not only transcribe meetings but also summarize main points, create action items and documents based on your meetings, help schedule follow-ups and more.
